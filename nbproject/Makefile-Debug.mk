...
${OBJECTDIR}/src/Steering_Wheel/Control_Wheel.o: src/Steering_Wheel/Control_Wheel.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Steering_Wheel/Control_Wheel.o src/Steering_Wheel/Control_Wheel.cpp

${OBJECTDIR}/src/Wrappers/Serial.o: src/Wrappers/Serial.cpp
	${MKDIR} -p ${OBJECTDIR}/src/Wrappers
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Wrappers/Serial.o src/Wrappers/Serial.cpp
