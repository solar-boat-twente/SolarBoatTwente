...
void Logger::write_struct_user_power(const structures::PowerInput *power_input_ptr, const structures::PowerOutput *power_output_ptr, const structures::UserInput *user_input_ptr){
    ...
    std::cerr <<std::dec<< "," << power_input_ptr->battery.cel_voltages[0] << "," << power_input_ptr->battery.cel_voltages[1] << "," << power_input_ptr->battery.cel_voltages[2] << "," << power_input_ptr->battery.cel_voltages[3] 
           ...
           << ","<< power_input_ptr->battery.state_of_charge << "," <<(int) (power_input_ptr->battery.error_number) 
           << ","<<(int) power_input_ptr->battery.error_location << "," << power_input_ptr->battery.max_temp<< ","  << power_input_ptr->battery.min_temp << "," << power_input_ptr->battery.balance_state
...
void Logger::write_struct_control_data(const structures::ControlData *control_data_ptr){
   std::cerr << "," << control_data_ptr->xsens.raw_pitch << "," << control_data_ptr->xsens.raw_roll << "," << control_data_ptr->xsens.filtered_pitch << ","
...
void Logger::write_struct_telemetry_input(const structures::TelemetryInput *telemetry_input_ptr){
   std::cerr << "," << telemetry_input_ptr->control.PID_height.P  << "," << telemetry_input_ptr->control.PID_height.I  << "," << telemetry_input_ptr->control.PID_height.D  << "," << telemetry_input_ptr->control.PID_height.N  << "," 
