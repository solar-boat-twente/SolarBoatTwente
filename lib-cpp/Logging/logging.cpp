...
void Logger::write_struct_user_power(const structures::PowerInput *power_input_ptr, const structures::PowerOutput *power_output_ptr, const structures::UserInput *user_input_ptr){
    ...
    cerr << "," << power_input_ptr->battery.cel_voltages[0] << "," << power_input_ptr->battery.cel_voltages[1] << "," << power_input_ptr->battery.cel_voltages[2] << "," << power_input_ptr->battery.cel_voltages[3] 
...
void Logger::write_struct_control_data(const structures::ControlData *control_data_ptr){
   cerr << "," << control_data_ptr->xsens.raw_pitch << "," << control_data_ptr->xsens.raw_roll << "," << control_data_ptr->xsens.filtered_pitch << ","
...
void Logger::write_struct_telemetry_input(const structures::TelemetryInput *telemetry_input_ptr){
   cerr << "," << telemetry_input_ptr->control.PID_height.P  << "," << telemetry_input_ptr->control.PID_height.I  << "," << telemetry_input_ptr->control.PID_height.D  << "," << telemetry_input_ptr->control.PID_height.N  << "," 
